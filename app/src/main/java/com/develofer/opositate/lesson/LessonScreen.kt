...
import com.develofer.opositate.test.LessonItem
import com.develofer.opositate.test.StudyItemList
...
fun LessonScreen(navController: NavHostController, mainViewModel: MainViewModel) {
    ...
    val lessonList = listOf(
        LessonItem(1, "Introducción", false),
        LessonItem(2, "Tema 1", true),
        LessonItem(3, "Tema 2", false),
        LessonItem(4, "Tema 3", false),
        LessonItem(5, "Tema 4", false),
